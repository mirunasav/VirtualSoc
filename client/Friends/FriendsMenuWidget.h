...
private:
    ...
    QPushButton *pBlockedListButton {nullptr};
...
public:
    ...
    constexpr static const char *pBlockedListLabelText = "Blocked Users";
    ...
    constexpr static const char *pBlockedListButtonText= "Blocked List";
